        ...
        <div class="flex space-x-6 items-center">
            ...
            <div class="flex items-center space-x-2">
                ...
                <RouterLink :to="{'name': 'postview', 'params': {'id': post.id}}"
                            class="text-gray-500 text-xs">{{ post.comments_count }} comments</RouterLink>
            </div>
...
export default {
    ...
    methods: {
        ...
        deletePost() {
            console.log('post_delete', this.post.id) 
            ...
            axios
                ...
                .then(response => {
                    ...
                    this.toastStore.showToast(5000, 'The post was deleted', 'bg-red-500 text-light')
